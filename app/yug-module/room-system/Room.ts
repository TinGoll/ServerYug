...
import createEngine, { ApiComponent, ApiEntity, Engine, Entity, IHistory, PropertyValue } from "yug-entity-system";
...
export default class Room{
    ...
    addActionsToHistory(ws: YugWebsocket, ...history: IHistory[]) {
